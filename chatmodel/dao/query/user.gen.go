...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Utime = field.NewInt32(tableName, "utime")
...
type user struct {
	...
	ALL      field.Asterisk
	ID       field.Int64  // 用户表主键
	Name     field.String // 用户名
	Password field.String // 密码
	Status   field.Int32  // 是否有效1.有效 2.无效
...
func (u *user) updateTableName(table string) *user {
	...
	u.Utime = field.NewInt32(table, "utime")
